...
export declare function getCompanyRoles(organisasjonsnummer: string): NORole[];
export declare function getCompany(organisasjonsnummer: string): NOCompany | undefined;
export declare function findCompany(query: string, exact?: boolean): NOCompany | null;
export declare function searchCompanies(query: string): NOCompany[];
export {};
